...
class TrxTenderRfqTermComp extends Model
{
    ...
    protected $table = 'trx_tender_rfq_compwiths';
    ...
    // Define the relationship with the M_cusprin model
    public function mCompwith()
    {
        return $this->belongsTo(M_term::class, 'm_term_compwith_id');
    }
}
