...
@section('title')
    Principle Edit - PT Kencana Zavira
@endsection
        ...
        <div class="row align-items-center" style="height:50px !important;">
            <div class="col-sm-6">
                <div class="breadcrumbs-area clearfix">
                    <h4 class="page-title pull-left">Principle Edit</h4>
                    <ul class="breadcrumbs pull-left">
                        <li><a href="{{ route('dashboard') }}">Dashboard</a></li>
                        <li><a href="{{ route('principle.index') }}">Principle</a></li>
                        <li><span>Edit Principle</span></li>
                    </ul>
                </div>
            </div>
    ...
    <div class="main-content-inner">
        <div class="row">
            ...
            <div class="col-12 mt-3">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title">Edit Principle</h4>
                        <form id="principle-form" action="{{ URL::route('principle.update', ['id' => $principle->id]) }}">
                            @method('PUT')
                            @csrf
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        <label for="name" class="col-sm-3 col-form-label required">Principle Name <span
                                                class="text-danger">*</span></label>
                                        <div class="col-sm-9">
                                            @if ($principle)
                                                <input type="text" class="form-control" name="name"
                                                    value="{{ $principle->name }}" required>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="address"
                                                value="{{ $principle->address }}" name="address" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="email" class="form-control" id="email" name="email"
                                                value="{{ $principle->email }}" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="number" class="form-control" id="phone" name="phone"
                                                value="{{ $principle->phone }}" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="pic_name" name="pic_name"
                                                value="{{ $principle->pic_name }}" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="email_pic" class="form-control" id="email_pic" name="email_pic"
                                                value="{{ $principle->email_pic }}" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="position" name="position"
                                                value="{{ $principle->position }}" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script type="module">
        $(document).ready(function() {
            $('#back-button').on('click', function() {
                window.location.href = "{{ route('principle.index') }}"
            })
            $('#principle-form').on('submit', function(e) {
                e.preventDefault();
                let valid = true;
                $('#principle-form .form-control[required], #principle-form .form-check-input[required]')
                    .each(function() {
                ...
                var url = "{{ URL::route('principle.update', ['id' => encrypt($principle->id)]) }}";
