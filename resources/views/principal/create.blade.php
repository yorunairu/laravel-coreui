...
@section('title')
    Principle Create - PT Kencana Zavira
@endsection
        ...
        <div class="row align-items-center" style="height:50px !important;">
            <div class="col-sm-6">
                <div class="breadcrumbs-area clearfix">
                    <h4 class="page-title pull-left">Principle Create</h4>
                    <ul class="breadcrumbs pull-left">
                        <li><a href="{{ route('dashboard') }}">Dashboard</a></li>
                        <li><a href="{{ route('principle.index') }}">Principle</a></li>
                        <li><span>Create Principle</span></li>
                    </ul>
                </div>
            </div>
    ...
    <div class="main-content-inner">
        <div class="row">
            ...
            <div class="col-12 mt-3">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title">Input New Principle</h4>
                        <form id="principle-form" action="{{ route('principle.store') }}">
                            @csrf
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="name" name="name"
                                                placeholder="Input Principle Name" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="email_pic" class="form-control" id="email_pic" name="email_pic"
                                                placeholder="Input Email PIC" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
...
@push('after-scripts')
    <script type="module">
        ...
        $('#submit-button').click(function(e) {
            e.preventDefault();
            let valid = true;
            $('#principle-form .form-control[required], #principle-form .form-check-input[required]').each(
                function() {
            ...
            $.ajax({
                ...
                error: function(xhr) {
                    Swal.fire("Error!", "Failed to save Principle.", "error");
