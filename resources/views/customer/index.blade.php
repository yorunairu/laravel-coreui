            ...
            <div class="col-12 mt-3">
                <div class="card">
                    <div class="card-body">
                        ...
                        @endif --}}
                            <a class="btn btn-xs btn-primary text-white" href="{{ route('customer.create') }}"><i
                                    class="fa fa-plus"></i> New Customer</a>
                            {{-- <button type="submit" class="btn btn-xs btn-primary" onclick="show()">tambah</button> --}}
                        </p>
                        <div class="clearfix"></div>
                        <div class="data-tables">
                            @include('layouts.includes.messages')
                            <table id="tableCustomer" class="text-center table w-100">
