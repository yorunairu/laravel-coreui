    ...
    <div class="main-content-inner">
        <div class="row">
            ...
            <div class="col-12 mt-3">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title">Tender Edit</h4>
                        <form id="tender-form"
                            action="{{ URL::route('sales.update', ['id' => $sales->id, 'type' => $type]) }}" method="POST"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="tender_type_non_tender" name="tender_type"
                                                    class="custom-control-input" value="non_tender" required
                                                    {{ $sales->tender_type == 'non_tender' ? 'checked' : '' }}
                                                    {{ $is_detail_tender ? 'disabled' : '' }}>
                                                <label class="custom-control-label" for="tender_type_non_tender">Pra
                                                    Quotation</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="no_rfq" class="col-sm-3 col-form-label required">RFQ <span
                                                class="text-danger">*</span></label>
                                        <div class="col-sm-9">
                                            <input type="text" value="{{ $sales->no_rfq }}" class="form-control"
                                                id="no_rfq" name="no_rfq" placeholder="Enter No RFQ" required
                                                {{ $is_detail_tender ? 'disabled' : '' }}>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" value="{{ $sales->name }}" class="form-control"
                                                id="name" name="name" placeholder="Input Tender" required
                                                {{ $is_detail_tender ? 'disabled' : '' }}>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text"
                                                value="{{ thousandSeparator($sales->total_price_tender) }}"
                                                class="form-control price-thousand" id="total_price_tender"
                                                name="total_price_tender" placeholder="Tender Value" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="doc_rfq_from_customer" class="col-sm-3 col-form-label">Document <span
                                                class="text-danger">*</span></label>
                                        <div class="col-sm-9">
                                            <input type="file" class="form-control" id="doc_rfq_from_customer"
                                                name="doc_rfq_from_customer" {{ $is_detail_tender ? 'disabled' : '' }}>
                                    ...
                                    <div class="form-group row">
                                        <label for="tanggal_keluar" class="col-sm-3 col-form-label">Tanggal Diterbitkan
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <select class="form-control select2-ajax"
                                                ...
                                                required {{ $is_detail_tender ? 'disabled' : '' }}>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea class="form-control" id="note" name="note" rows="4" placeholder="Enter Note"
                                                {{ $is_detail_tender ? 'disabled' : '' }}>{{ $sales->notes }}</textarea>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="datetime-local" class="form-control" id="deadline"
                                                name="deadline" placeholder="Enter Deadline"
                                                value="{{ $sales->deadline }}" required
                                                {{ $is_detail_tender ? 'disabled' : '' }}>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <select class="form-control" name="status_win_lost" id="status_win_lost"
                                                {{ $is_detail_tender ? 'disabled' : '' }}>
                                                <option value=""
                                                    {{ $sales->status_win_lost == null ? 'selected' : '' }}>Yes</option>
                                                <option value="lost"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <select class="form-control" name="is_bb_bond" id="is_bb_bond">
                                                <option value="">To Be Decided</option>
                                                <option value="true"
                                                    {{ $sales->is_bb_bond === 'true' ? 'selected' : '' }}>Yes</option>
                                                <option value="false"
                                                    {{ $sales->is_bb_bond === 'false' ? 'selected' : '' }}>No</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div id="bid_bond_fields" style="display: none;">
                                        <div class="form-group row">
                                            <label for="bb_no_guarantee" class="col-sm-3 col-form-label">BB No Guarantee
                                                <span class="text-danger">*</span></label>
                                            <div class="col-sm-9">
                                        ...
                                        <div class="form-group row">
                                            <label for="bb_price" class="col-sm-3 col-form-label">BB Price <span
                                                    class="text-danger">*</span></label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control price-thousand prevent-zero"
                                                    value="0"
                                        ...
                                        <div class="form-group row">
                                            <label for="bb_time_periode" class="col-sm-3 col-form-label">BB Time Periode
                                                <span class="text-danger">*</span></label>
                                            <div class="col-sm-9">
                            ...
                            {{-- <a href="#" id="draft-button" class="btn btn-xs btn-success mt-4 pr-4 pl-4"><i class="fa fa-bookmark"></i> Draft</a> --}}
                            <a href="#" id="submit-button" class="btn btn-xs btn-primary mt-4 pr-4 pl-4"><i
