...
@endphp --}}
                            ...
                            <div class="table-responsive">
                                <table class="table w-100 table-striped table-hover table-bordered" id="table-rfq">
                                    <thead class="bg-success text-white">
                                        ...
                                        <th class="text-left v-align-middle">Date Delivery Doc RFQ</th>
                                        <th class="text-left v-align-middle">Payment Method</th>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="date" name="date_deadline" id="date_deadline" class="form-control"
                                            value="{{ !empty($sales->deadline) ? date('Y-m-d', strtotime('-3 days', strtotime($sales->deadline))) : date('Y-m-d', strtotime('-4 days')) }}"
                                            required>
                                    </div>
                                </div>
                                <div class="form-group row">
    ...
    <div class="modal fade" id="updateDeliveryDateModal" tabindex="-1" role="dialog"
        aria-labelledby="updateDateLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document"> <!-- Add modal-lg class for a larger modal -->
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="updateDateLabel">Update Material Delivery Date From Principle : <span
                            class="updateDate-principle"></span></h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
    ...
    <<<<<<< HEAD <!-- Modal HTML -->
        <div class="modal fade" id="updatePaymentMethodModal" tabindex="-1" role="dialog"
            aria-labelledby="updatePaymentMethodLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document"> <!-- Add modal-lg class for a larger modal -->
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="updatePaymentMethodLabel">Update Payment Method From Principle : <span
                                class="updatePaymentMethod-principle"></span></h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <form id="updatePaymentMethodForm" class="form-horizontal" action="#">
                            <!-- Add form-horizontal class for better layout -->
                            @csrf
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group row">
                                        <label for="payment_method" class="col-sm-4 col-form-label">Payment Method<span
                                                class="text-danger">*</span></label>
                                        <div class="col-sm-2">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                        <button type="submit" class="btn btn-primary" id="saveupdatePaymentMethod">Save</button>
                        =======
                        <!-- Modal HTML -->
                        <div class="modal fade" id="updateGoodsModal" tabindex="-1" role="dialog"
                            aria-labelledby="updateGoodsLabel" aria-hidden="true">
                            <div class="modal-dialog modal-lg" role="document">
                                <!-- Add modal-lg class for a larger modal -->
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="updateGoodsLabel">Update Payment Method From Principle
                                            : <span class="updateGoods-principle"></span></h5>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                    </div>
                                    <div class="modal-body">
                                        <form id="updateGoodsForm" class="form-horizontal" action="#">
                                            <!-- Add form-horizontal class for better layout -->
                                            @csrf
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group row">
                                                        <label for="payment_method"
                                                            class="col-sm-4 col-form-label">Payment Method<span
                                                                class="text-danger">*</span></label>
                                                        <div class="col-sm-2">
                                                            <select name="payment_method" id="payment_method"
                                                                class="form-control select2">
                                                            ...
                                                            <input type="number" name="payment_method"
                                                                id="payment_method" class="form-control prevent-zero"
                                                                value="{{ !empty($sales->payment_method) ? $sales->payment_method : '30' }}"
                                                                required>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="submit" class="btn btn-primary" id="saveupdateGoods">Save</button>
                                    </div>
                                    >>>>>>> 9eb5b2e42196d381684ba9dd592b8f6c9fc5c328
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="modal fade" id="updatePriceFromPrincipleModal" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog modal-lg" role="document">
                                ...
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="updatePriceFromPrincipleLabel">Update Price From
                                            Principle : <span class="updatePriceFromPrinciple-principle"></span></h5>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                    </div>
                                    <div class="modal-body">
                                        <form id="updatePriceFromPrincipleForm" class="form-horizontal" action="#">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group row">
                                                        <label for="currency" class="col-sm-3 col-form-label">Price From
                                                            Principle <span class="text-danger">*</span></label>
                                                        <div class="col-sm-2">
                                                            <select class="form-control"
                                                                data-url="{{ URL::to('select2/get-currency') }}"
                                                        ...
                                                        <div class="col-sm-7">
                                                            <input type="text" class="form-control" id="price"
                                                                name="price" placeholder="Price from Principle"
                                                                required>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="submit" class="btn btn-primary"
                                            id="saveupdatePriceFromPrinciple">Save</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="modal fade" id="updateDocQuoFromPrincipleModal" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog modal-lg" role="document">
                                ...
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="updateDocQuoFromPrincipleLabel">Update Price From
                                            Principle : <span class="updateDocQuoFromPrinciple-principle"></span></h5>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                    </div>
                                    <div class="modal-body">
                                        <form id="updateDocQuoFromPrincipleForm" class="form-horizontal" action="#"
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group row">
                                                        <label for="doc_quo_from_principle"
                                                            class="col-sm-3 col-form-label">Document <span
                                                                class="text-danger">*</span></label>
                                                        <div class="col-sm-9">
                                                            <input type="file" class="form-control"
                                                                id="doc_quo_from_principle" name="doc_quo_from_principle"
                                                                accept=".pdf">
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary"
                                            data-dismiss="modal">Close</button>
                                        <button type="submit" class="btn btn-primary"
                                            id="saveupdateDocQuoFromPrinciple">Save</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    @push('after-scripts')
                        ...
                        <script type="module">
                            $(document).ready(function() {
                                        ...
                                        $(document).on('click', '.proc-update-payment-method', function() {
                                            // Get the data-id attribute of the clicked button
                                            var rfqPrincipleId = $(this).data('id');

                                            // Set the form action to include the id
                                            var updateUrl = "{{ route('procurement.update-payment-method', ['id' => ':id']) }}"
                                                .replace(':id', rfqPrincipleId);
                                            $('#updatePaymentMethodForm').attr('action', updateUrl);
                                            $('.updatePaymentMethod-principle').html($(this).data('name'));
                                        ...
                                        $(document).on('click', '#saveupdateDate', function() {
                                            ...
                                            var formActionUrl = $('#updateDateForm').attr('action'); // Get the form action URL
                                        ...
                                        HEAD
                                        // Handle the form submission
                                        $(document).on('click', '#saveupdatePaymentMethod', function() {
                                                    // Swal.fire({
                                                    //     title: 'Are you sure?',
                                                    //     text: "You won't be able to revert this!",
                                                    //     icon: 'warning',
                                                    ...
                                                    // }).then((result) => {
                                                    //     if (result.isConfirmed) {
                                                    var formData = $('#updatePaymentMethodForm').serialize();
                                                    var formActionUrl = $('#updatePaymentMethodForm').attr('action'); // Get the form action URL
                                                    ...
                                                    $.ajax({
                                                                ...
                                                                success: function(response) {
                                                                    if (response.status) {
                                                                        Swal.fire(
                                                                            'Saved!',
                                                                            'Your RFQ Payment Method has been saved.',
                                                                            'success'
                                                                        );

                                                                        // Clear the form
                                                                        $('#updatePaymentMethodForm')[0].reset();

                                                                        // Hide the modal
                                                                        $('#updatePaymentMethodModal').modal('hide');

                                                                        $('#table-rfq').DataTable().ajax.reload();
                                                                    } else {
                                                                        Swal.fire(
                                                                            'Error!',
                                                                            'There was a problem saving your RFQ Payment Method .',
                                                                            'error'
                                                                        );
                                                                    }
                                                                },
                                                                error: function(error) {
                                                                    ...
                                                                    =
                                                                    // Handle the form submission
                                                                    $(document).on('click', '#saveupdateGoods', function() {
                                                                        // Swal.fire({
                                                                        //     title: 'Are you sure?',
                                                                        //     text: "You won't be able to revert this!",
                                                                        //     icon: 'warning',
                                                                        ...
                                                                        // }).then((result) => {
                                                                        //     if (result.isConfirmed) {
                                                                        var formData = $('#updateGoodsForm').serialize();
                                                                        var formActionUrl = $('#updateGoodsForm').attr(
                                                                        ...
                                                                        $.ajax({
                                                                            ...
                                                                            success: function(response) {
                                                                                if (response.status) {
                                                                                    Swal.fire(
                                                                                        'Saved!',
                                                                                        'Your RFQ Date Goods Delivery has been saved.',
                                                                                        'success'
                                                                                    );

                                                                                    // Clear the form
                                                                                    $('#updateGoodsForm')[0].reset();

                                                                                    // Hide the modal
                                                                                    $('#updateGoodsModal').modal(
                                                                                        'hide');

                                                                                    $('#table-rfq').DataTable().ajax
                                                                                        .reload();
                                                                                } else {
                                                                                    >>>
                                                                                    >>>
                                                                                    >
                                                                                    9 eb5b2e42196d381684ba9dd592b8f6c9fc5c328
                                                                                    Swal.fire(
                                                                                        'Error!',
                                                                                        'There was a problem saving your RFQ Payment Method .',
                                                                                        'error'
                                                                            ...
                                                                            error: function(error) {
                                                                                Swal.fire(
                                                                                    'Error!',
                                                                                    'There was a problem saving your RFQ Date Goods Delivery .',
                                                                                    'error'
                                                                                );
                                                                            }
                                                                        });
                                                                    ...
                                                                    $(document).on('click', '#saveupdatePriceFromPrinciple', function() {
                                                                        ...
                                                                        // }).then((result) => {
                                                                        //     if (result.isConfirmed) {
                                                                        var formData = $('#updatePriceFromPrincipleForm')
                                                                            .serialize();
                                                                        ...
                                                                        $.ajax({
                                                                            ...
                                                                            success: function(response) {
                                                                                if (response.status) {
                                                                                    ...
                                                                                    // Clear the form
                                                                                    $('#updatePriceFromPrincipleForm')[
                                                                                        0].reset();

                                                                                    // Hide the modal
                                                                                    $('#updatePriceFromPrincipleModal')
                                                                                        .modal('hide');
                                                                    ...
                                                                    $(document).on('click', '#saveupdateDocQuoFromPrinciple', function() {
                                                                        ...
                                                                        var formData = new FormData($(
                                                                            '#updateDocQuoFromPrincipleForm')[0]);
                                                                        var formActionUrl = $('#updateDocQuoFromPrincipleForm')
                                                                            .attr(
                                                                                'action'); // Get the form action URL
                                                                        ...
                                                                        $.ajax({
                                                                            ...
                                                                            success: function(response) {
                                                                                if (response.status) {
                                                                                    ...
                                                                                    // Clear the form
                                                                                    $('#updateDocQuoFromPrincipleForm')[
                                                                                        0].reset();

                                                                                    // Hide the modal
                                                                                    $('#updateDocQuoFromPrincipleModal')
                                                                                        .modal('hide');
                        ...
                        <script type="module">
                            /*================================
                                                                                                                                       ...
                                                                                                                                       ==================================*/
                            $(document).ready(function() {
                                function confirmAndSendRfq(url) {
                                    Swal.fire({
                                        title: 'Are you sure?',
                                        text: "Do you want to send this RFQ to Procurement?",
                                        icon: 'warning',
                                        showCancelButton: true,
                                        ...
                                        if (result.isConfirmed) {
                                            $.ajax({
                                                ...
                                                success: function(response) {
                                                    Swal.fire(
                                                        'Sent!',
                                                        'RFQ has been sent successfully.',
                                                        'success'
                                                    );
                                                },
                                                error: function(response) {
                                                    Swal.fire(
                                                        'Error!',
                                                        'An error occurred while sending the RFQ.',
                                                        'error'
                                                    );
                                                }
                                            });
                            ...
                            function confirmWinner(winnerUrl, principleName, price, currency) {
                                Swal.fire({
                                    title: 'Are you sure?',
                                    html: `
                <div style="text-align: center; font-size: 1.1em;">
                    <p><strong>${principleName}</strong> as Winner!</p>
