        ...
        <div class="row align-items-center" style="height:50px !important;">
            <div class="col-sm-6">
                <div class="breadcrumbs-area clearfix">
                    <h4 class="page-title pull-left">Detail Tender Post</h4>
                    <ul class="breadcrumbs pull-left">
                        <li><a href="{{ route('procurement.index') }}">Procurement Post</a></li>
                        ...
                        <div class="text-left">
                            ...
                            @if ($check_price && in_array($sales->status_journey, ['3']))
                                <button title="Review Price Tender" type="button"
                                    class="btn btn-xs btn-success m-1 proc-update-review" data-toggle="modal"
                                    data-target="#updateReviewModal" data-id="{{ encrypt($sales->id) }}"
                                    data-name="{{ $sales->name }}" id="updateReview"><i class="fa fa-star"></i>
                                    Review</button><br>
                            @endif
                            ...
                            @if (in_array($sales->statusJourney->order, ['4']))
                                <button title="Quotation to Customer" type="button"
                                    ...
                                    data-id="{{ encrypt($sales->id) }}" data-name="{{ $sales->name }}"
                                    id="procced-to-po"><i class="fa fa-spinner"></i> Procced to PO</button><br>
                            @endif
                            {{-- END PROCESS TO PO --}}
                            ...
                            @if (in_array($sales->statusJourney->order, ['5', '6']))
                                <button title="po to principle" type="button"
                                    ...
                                    data-name="{{ $sales->name }}" id="procced-to-po"><i class="fa fa-file-pdf-o"></i>
                                    PO To Principle</button><br>
                            @endif
                ...
                <div class="card mt-3">
                    <div class="card-body">
                        ...
                        <div class="data-tables">
                            @include('layouts.includes.messages')
                            <div class="table-responsive">
                                <table class="table w-100 table-striped table-hover table-bordered" id="table-material">
                                    <thead class="bg-success text-white">
                                        <th class="text-center v-align-middle">No</th>
                                        <th class="text-left v-align-middle">Material Code</th>
                                        <th class="text-left v-align-middle">Material Description</th>
                                        <th class="text-left v-align-middle">Qty</th>
                                        <th class="text-left v-align-middle">Uom</th>
                                        <th class="text-right v-align-middle">Price Principle</th>
                                        <th class="text-right v-align-middle">Price KZ</th>
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <th id="totalPrincipleFooter"></th>
                                            <th id="totalKzFooter"></th>
                                            <th id="totalMarginFooter"></th>
                                        </tr>
                                    </tfoot>
                                </table>
                            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="quoPDF" class="form-horizontal"
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <select name="additional_value[]" id="additional_value"
                                            class="form-control select2" data-placeholder="Additional Value"
                                ...
                                <div class="form-group row">
                                    <label for="price_validity" class="col-sm-4 col-form-label">Price Validity <span
                                            class="text-danger">*</span></label>
                                    <div class="col-sm-8">
                                        <select name="price_validity[]" id="price_validity" class="form-control select2"
                                ...
                                <div class="form-group row">
                                    <label for="delivery_time" class="col-sm-4 col-form-label">Delivery Time <span
                                            class="text-danger">*</span></label>
                                    <div class="col-sm-8">
                                        <select name="delivery_time[]" id="delivery_time" class="form-control select2"
                        ...
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                        <button type="submit" class="btn btn-primary" id="saveNewRFQ">Print to PDF</button>
                ...
                <div class="modal-body">
                    <form id="tender-po-customer"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label for="trx_tender_id" class="col-sm-3 col-form-label required">Principle Name
                                        <span class="text-danger">*</span></label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="trx_tender_id"
                                            name="trx_tender_id" value="{{ $principle->principle->name ?? 'N/A' }}"
                                            readonly required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="no_po" class="col-sm-3 col-form-label">No PO <span
                                            class="text-danger">*</span></label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="no_po" name="no_po"
                                            placeholder="Input no PO" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="date_po" class="col-sm-3 col-form-label">Date PO <span
                                            class="text-danger">*</span></label>
                                    <div class="col-sm-9">
                                        <input type="date"class="form-control" id="date_po" name="date_po" required>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <label for="type" class="col-sm-3 col-form-label">Type <span
                                            class="text-danger">*</span></label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group row">
                                    <label for="doc_po" class="col-sm-3 col-form-label">Document <span
                                            class="text-danger">*</span></label>
                                    <div class="col-sm-9">
                                        <input type="file"class="form-control" id="doc_po" name="doc_po"
                                            placeholder="Upload doc" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="notes" class="col-sm-3 col-form-label">Note <span
                                            class="text-danger">*</span></label>
                                    <div class="col-sm-9">
                                        <textarea class="form-control" id="notes" name="notes" rows="4" placeholder="Input Note"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            $('#table-material').DataTable({
                ...
                ajax: {
                    ...
                    dataSrc: function(json) {
                        ...
                        // Fetch the total values from the JSON response
                        var totalPrinciple = json.totalPrinciple || 0;
                        var totalKz = json.totalKz || 0;
                        var totalMargin = json.totalMargin || 0;
                        var totalMarginPercentage = json.totalMarginPercentage || 0;
                        var currency = json.currency || '';

                        // Log the total values to ensure they are being fetched
                        console.log('Total Principle:', totalPrinciple);
                        console.log('Total KZ:', totalKz);
                        console.log('Total Margin:', totalMargin);
                        console.log('Percentage Margin:', totalMarginPercentage);
                        console.log('Currency:', currency);

                        // Update footer with formatted values
                        $('#totalPrincipleFooter').html(thousandSeparator(totalPrinciple) + ' ' +
                            currency);
                        $('#totalKzFooter').html(thousandSeparator(totalKz) + ' ' + currency);
                        $('#totalMarginFooter').html(thousandSeparator(totalMargin) + ' ' + currency +
                            ' (' + totalMarginPercentage.toFixed(2) + '%)');

                        // Return the data portion of the response to DataTables
                        return json.data;
                    }
                },
                columns: [{
