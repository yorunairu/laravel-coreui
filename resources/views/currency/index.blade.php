...
@section('title')
    Master Data Currency - PT. Kencana Zavira
@endsection
        ...
        <div class="row align-items-center" style="height:50px !important;">
            <div class="col-sm-6">
                <div class="breadcrumbs-area clearfix">
                    <h4 class="page-title pull-left">Master Data Currency</h4>
    ...
    <div class="main-content-inner">
        <div class="row">
            ...
            <div class="col-12 mt-3">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title float-left">Currency List</h4>
                        ...
                        @endif --}}
                            ...
                            <button type="submit" class="btn btn-xs btn-primary" onclick="showModal()"><i
                                    class="fa fa-plus"></i> New Currency</button>
                        </p>
                        <div class="clearfix"></div>
                        <div class="data-tables">
                            @include('layouts.includes.messages')
                            <table id="tableCurrency" class="text-center table w-100">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="#" id="formCurrency">
                        <input type="hidden" name="id" id="id">
                        <div class="form-group row">
                            <label for="currency" class="col-sm-3 col-form-label required">Currency <span
                        ...
                        <div class="form-group row">
                            <label for="price_rate" class="col-sm-3 col-form-label required">Price Rate <span
                                    class="text-danger">*</span></label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control price-thousand" name="price_rate" id="price_rate">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="price_rate" class="col-sm-3 col-form-label required">Date Rate <span
                                    class="text-danger">*</span></label>
                            <div class="col-sm-9">
                                <input type="date" class="form-control price-thousand" name="price_rate" id="price_rate">
                            </div>
                        </div>
...
@push('after-scripts')
    ...
    <script type="module">
        ...
        function showModal() {
            ...
            $('#modalTitle').text('Create Currency');
            $('#formCurrency')[0].reset();
        ...
        function editModal(e) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#price_rate').val(result.price_rate);
                    // alert(result.name);
                },
                error: function(xhr) {
