            ...
            <div class="col-sm-6">
                <div class="breadcrumbs-area clearfix">
                    ...
                    <ul class="breadcrumbs pull-left">
                        <li><a href="{{ route('list-tender.index') }}">List Tender</a></li>
                            ...
                            <div class="table-responsive">
                                <table class="table w-100 table-striped table-hover table-bordered" id="table-rfq">
                                    <thead class="bg-success text-white">
                                        ...
                                        <th class="text-center v-align-middle">Reviewed by</th>
                                        <th class="text-center v-align-middle">Reviewed at</th>
        ...
        <div class="modal-dialog modal-lg" role="document"> <!-- Add modal-lg class for a larger modal -->
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary" id="saveupdateReview">Save</button>
                </div>
            </div>
        </div>
    </div>
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '#saveupdateReview', function() {
                Swal.fire({
                    ...
                    confirmButtonColor: '#3085d6',
                    cancelButtonColor: '#d33',
                    confirmButtonText: 'Yes, save the review!'
                }).then((result) => {
                    if (result.isConfirmed) {
